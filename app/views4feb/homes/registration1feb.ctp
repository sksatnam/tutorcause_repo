           ...
           <input type="hidden" name="data[Member][email]" id="facebook_email" value="" />
			...
			<?php /*?>		
					...
					?><?php */?>
                         ...
                         <div class="stepThreeFormRow" >
                          <label style="width:330px;"><b>I agree to the TutorCause <a href="<?php echo HTTP_ROOT;?>standard_terms" style="color: #1B8FD8; text-decoration:underline;">Terms of Service</a></b></label>

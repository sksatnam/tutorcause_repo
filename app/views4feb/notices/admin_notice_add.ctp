...
function checkCheckBoxes(theForm) {
	...
	if (!document.getElementById('group_id6').checked && !document.getElementById('group_id7').checked && !document.getElementById('group_id8').checked) 
	{
		$("#group_id8").addClass("required");
		return false;
	} else { 	
		return true;
	}

...
<?php	echo $this->Session->flash(); ?>
  ...
  <div id="tutor-wrap"> 
    ...
    <div class="forgotEmailOutr" style="width:370px;">
        ...
        <input type="password" name="data[Member][pwd]" id="userPassword" value="" class="required" style="width:200px;"/>
        </div>
    </div>
    ...
    <div class="forgotEmailOutr" style="width:370px;">
        ...
        <div style="width:240px; float:left;">
        <input type="password" name="data[Member][cPassword]" value="" class="required" style="width:200px;"/>
        </div>
    </div>

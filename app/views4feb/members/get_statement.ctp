...
/*	body { font: 0.8em Arial, sans-serif; }*/
	...
	.amountRight{width:50px;padding:3px 2px;float:left;}
	.clear{clear:both;}
	.payDiv ul li{list-style:none;margin-left:200px;}
      ...
      <div class="center-col" style="width:auto">
				...
				<div class="PayCharity">
					...
					<ul>
						...
						<li class="liMiddle"><?php echo $charity['CauseTutor']['grant'];?> %</li>
						<li class="liRight"><?php 
						
						$causeAmount = ($charity['CauseTutor']['grant']/100)*$amounts['actualAmonut'];

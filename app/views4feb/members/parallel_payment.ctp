...
/*$filepath = HTTP_ROOT.'files/paypalplatform.php';
...
$actionType			= "PAY";
$cancelUrl			= HTTP_ROOT."Homes/failure";	// TODO - If you are not executing the Pay call for a preapproval,
												//        then you must set a valid cancelUrl for the web approval flow
												//        that immediately follows this Pay call
$returnUrl			= HTTP_ROOT."Homes/success";	// TODO - If you are not executing the Pay call for a preapproval,
...
$receiverEmailArray	= array(
		'tutor1_1315491578_per@gmail.com',
		'tutor_1315377608_biz@gmail.com',
		);
...
$senderEmail					= "tutor_1315330696_biz@gmail.com";		// TODO - If you are executing the Pay call against a preapprovalKey, you should set senderEmail

...
<?php	echo $this->Session->flash(); ?>
	...
	<div class="public_profile_cointainer">
    	<div class="public_profile_cointainer_Ist">
			...
			echo '<div style="clear:both"></div>';
			echo $html->image('frontend/request.png',array('style'=>'width:25px;margin:4px 0px 0px 15px'))."&nbsp;".$html->link('Cause Requests ('.$CountRequest.')',array('controller'=>'members', 'action'=>'cause_request'));
			echo '<div style="clear:both"></div>';

		...
		?>
			...
			<div id="userAddPanel" style="min-height:520px;">
             ...
             <div id="flashmsg" style="float:left; padding-left:10px; padding-bottom:10px;"><b><?php echo $this->Session->flash(); ?></b></div><br />
                 ...
                 <?php echo $form->create('member', array('action' => 'subscribe','admin'=> true,'id'=>'subscribe')); ?>
				...
				<div class="paddinSet">
					<fieldset id="personal-info">
                        ...
                        <br /><br />
							...
							<input name="data[email]" type="text" maxlength="50" value="<?php echo $memberdata['Member']['email'] ?>" />
							<br /><br />
                            
							<label class="dpkLab" for="UserPassword" class="field-title">First Name :</label>
							<input type="text" name="data[first]" value="<?php echo $memberdata['userMeta']['fname'] ?>" />
							<br /><br />
                            
                            <label class="dpkLab" for="UserPassword" class="field-title">Last Name :</label>
							<input name="data[last]" type="text" value="<?php echo $memberdata['userMeta']['lname'] ?>" />
							<br /><br />

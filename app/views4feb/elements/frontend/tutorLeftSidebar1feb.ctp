      ...
      <div class="left-sidebar">
        ...
        <div id="accordian">
          <div class="container">
            ...
            <div class="acc_container" style="display: none; ">
              <div class="block">
                <ul class="account-links">
                  ...
                  <li><a href="<?php echo HTTP_ROOT.'members/tutor_causes/';?>">My Causes</a></li>                  
            ...
            <h2 class="acc_trigger"><a href="#">My Causes</a></h2>
            <div class="acc_container" style="display: block; ">
				...
				{
				 echo '<li style="font-family: Myriad Pro; color: rgb(24, 73, 122); font-size: 16px;padding-top: 25px; padding-left: 15px;" >'.' There are currently no causes for this tutor'.'</li>';
				}
				?>
                </ul>
              </div>

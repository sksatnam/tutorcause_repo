		 ...
		 ?> 	 
				<div class="<?php if($n%2==0){ echo 'oddBox';}?> classesInner">
					<div class="classesInnerLeft">
						...
						$startclass = $result['PaymentHistory']['booked_start_time'];
						$endclass = $result['PaymentHistory']['booked_end_time'];
					...
					<div class="classesInnerMiddle">
						...
						<div class="classdate"><?php echo date('l, F d, Y g:i A (T)',strtotime($startclass));?><!--Friday, January 06, 2012 7:31 PM--></div>

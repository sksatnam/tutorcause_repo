      ...
      <div id="accordian">
        ...
        <ul>
          ...
          <!--    <img src="images/pic-1.jpg" width="57" height="58" />--></div>
            ...
            {
			?>
              <li> <p style=" font-family: Myriad Pro; color: rgb(24, 73, 122); font-size: 16px; margin-left:20px; margin-top:25px;"><b>There are currently no tutors <br/><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for this cause</b></p></li>

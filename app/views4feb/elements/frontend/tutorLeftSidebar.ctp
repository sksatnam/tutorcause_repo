...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$("#tutortext").autocomplete(
		  ajax_url+"/members/get_cause_name",
		  {
				delay:10,
				minChars:1,
				matchSubset:1,
      ...
      <div class="left-sidebar">
		...
		<div class="imageChange">Change Profile Picture</div>    
          ...
          <div class="student-name">
            <div class="student">
			  <?php
              $tutorname = $getBalance['userMeta']['fname'].' '.$getBalance['userMeta']['lname'];
              echo $tutorname;
              ?>
            </div>
          </div>
        ...
        <div id="accordian">
          <div class="container">
            ...
            <div class="acc_container" style="display: none; ">
              <div class="block">
                <ul class="account-links">
                  ...
                  <li><a href="<?php echo HTTP_ROOT.'members/tutor_causes/';?>">My Non-Profit</a></li>                  
                  <li><a href="<?php echo HTTP_ROOT.'members/cause_request/';?>"><?php echo 'Cause Requests '.$CountRequest.'';?></a></li>  
				   ...
				   <?php
				   $findname = $getBalance['userMeta']['fname'].' '.$getBalance['userMeta']['lname'];
            ...
            <h2 class="acc_trigger"><a href="#">My Non-Profit</a></h2>
            <div class="acc_container" style="display: block; ">
				...
				?>
                  ...
                  <li class="cause-bg"><a href="<?php echo HTTP_ROOT.'members/cause/'.$causeurl;?>">
                    <div class="profile-wrap">
                      <div class="profile-pic">
						<?php			
                        $causeimage = $this->requestAction('members/getcauseProfile/'.$cr['CauseTutor']['cause_id']); 
                      ...
                      <div class="profile-info">
                        <div class="name-price">
                          <h4 class="cause-name"><?php echo $cr['Cause']['userMeta']['cause_name'];?>&nbsp;</h4>
                          <div class="amount-raised">
                                <div class="amount-raised-text">Amount Raised:</div>
                                <div class="raised-amt">
                                <?php 
								$requesturlcause = '/members/cause_amount_raised/'.$cr['CauseTutor']['cause_id'];
				...
				{
				 echo '<li style="font-family: Myriad Pro; color: rgb(24, 73, 122); font-size: 16px;padding-top: 25px; padding-left: 15px;" >'.' There are currently no non-profit for this tutor'.'</li>';
				}
				?>
                </ul>
              </div>
            ...
            <div class="acc_container" style="display: none; ">
              <div class="block">
               ...
               <form name="causesearch" id="causesearch" action="<?php echo HTTP_ROOT.'members/find_cause';?>" method="post" >

...
<table class="table-short" style="width:100%;" border="0">
	...
	<tr class="odd">
      ...
      <?php   if($member['Member']['group_id']==1 || $member['Member']['group_id']== 2|| $member['Member']['group_id']==3||$member['Member']['group_id']==4|| $member['Member']['group_id']== 5|| $member['Member']['group_id']==7 || $member['Member']['group_id']==8)
	  {
		  ?>
	  ...
	  if($member['Member']['group_id']==6 )
	  {
		  ?>
		  <td class="row-nav-user" style="white-space:nowrap;">
			<?php echo $html->link('', array('action'=>'edit_cause_schoolinfo', base64_encode(convert_uuencode($member['Member']['id'])),'admin' => true), array('class'=>'table-edit-link','title' => 'Edit')); ?>
            <?php echo $html->link('', 'javascript:void(0);', array("title" => "delete",'class' => 'table-delete-link delete-single-user','id' => "del_".$member['Member']['id']), false); ?>
            </td>
	<?php
	  }

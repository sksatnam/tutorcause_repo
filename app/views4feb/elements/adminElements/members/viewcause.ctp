...
<table class="table-short" style="width:100%;" border="0">
	...
	<tr class="odd">
        ...
        <?php echo $html->link('', array('controller'=>'members','action'=>'edit_cause_schoolinfo', base64_encode(convert_uuencode($cause['Member']['id'])),'admin' => true), array('class'=>'table-edit-link','title' => 'Edit')); ?>

...
<table class="table-short" style="width:100%;" border="0">
	<tr id="header">
	<td><b>S.No.</b></td>
    <td style="color:#00F; padding-left:15px"><b><?php echo $paginator->sort('School Name','School.school_name');?></b></td>
   
     <td style="color:#00F; padding-left:15px"><b><?php echo $paginator->sort('Course Code','Course.course_id');?></b></td>
     <td style="color:#00F; padding-left:30px"><b><?php echo $paginator->sort('Course Title','Course.course_title');?></b></td>
	 <td style="color:#00F;"><b><?php echo $paginator->sort('Registered','Course.created') ?></b></td>  
	...
	<tr class="odd">
        ...
        <td style="padding-left:15px" ><?php echo $course['Course']['course_id'];?></td>
        <td style="padding-left:30px"><?php echo $course['Course']['course_title'];?></td> 
        <td>
       
		<?php $datetime = strtotime($course['Course']['created']);echo date("F d, Y", $datetime);  ?>
		</td>       
		<td>

  ...
  <div id="content">
    ...
    <div class="box">
        	...
        	<h4 style="-moz-border-radius-topleft: 5px;-moz-border-radius-topright: 5px;" class="white rounded_by_jQuery_corners">Cause Withdrawal<a href="javascript:void(0);" class="expandGrid">EXPAND GRID</a></h4>
		 ...
		 <?php echo $this->Form->create('payment_histories', array('action' => 'cause_withdrawal','admin'=> true )); ?>
...
<input type="reset" value="Reset"  style="width:100px; margin-left:20px; background-color:#B3BBC2; color:#FFFFFF" />
            ...
            <div style="-moz-border-radius-bottomleft: 5px;-moz-border-radius-bottomright: 5px;" class="box-container rounded_by_jQuery_corners">
					...
					<?php echo $form->input('pagingStatus',array('type' => 'hidden','value'=>HTTP_ROOT.'admin/payment_histories/cause_withdrawal/','id' => 'pagingStatus')); ?>

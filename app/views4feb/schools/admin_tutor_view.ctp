  ...
  <div id="content">
	...
	<div id="mid-col">    	
		<div class="box">
            	...
            	<h4 style="-moz-border-radius-topleft: 5px;-moz-border-radius-topright: 5px;" class="white rounded_by_jQuery_corners">View Tutor<a href="javascript:void(0);" class="expandGrid">SHRINK GRID</a></h4>
			...
			<?php //pr($this->data);?>
				<?php echo $form->create('member',array("url" => $html->url(array('action'=>'tutor_view',$schoolid,"admin" => true), true)));?>
...
<input type="reset" value="Reset"  style=" width:100px; margin-left:20px; background-color:#B3BBC2; color:#FFFFFF" />
			...
			<?php echo $form->end(); ?>	
            	...
            	<div style="-moz-border-radius-bottomleft: 5px;-moz-border-radius-bottomright: 5px;" class="box-container rounded_by_jQuery_corners">
                    ...
                    <div align="right"><?php echo $html->link("Export to Excel",array('controller'=>'schools', 'action'=>'exporttutorcsv',$schoolid,'admin' => true)); ?></div>

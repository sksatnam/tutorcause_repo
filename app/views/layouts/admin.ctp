		...
		<ul id="menu">
			...
			<li class="<?php echo $parentClass =isset($parentClass) ? $parentClass : ''; ?>"><a style="background-position: 0px 0px;" class="top-level" href="#">Users <span>&nbsp;</span></a>
			  <ul style="display: none;">
                ...
                <li><?php echo $html->link('Approve Tutor', '/admin/members/approve_tutor'); ?></li>
			  </ul>
			</li>
            <li class="<?php echo $causeClass =isset($causeClass) ? $causeClass : ''; ?>"><a style="background-position: 0px 0px;" class="top-level" href="#">Causes <span>&nbsp;</span></a>
			  <ul style="display: none;">
				<?php /*?><li><?php echo $html->link('View Users', '/admin/members/view'); ?></li><?php */?>
				<li><?php echo $html->link('View Cause', '/admin/members/non_profit_view'); ?></li>
			  </ul>
			</li>
            ...
            ?>
                ...
                <li ><?php echo $html->link('Email Template', '/admin/members/email_template'); ?></li>
             <?php 
			}
			?>  
				<li ><?php echo $html->link('Change Password', '/admin/members/change_password'); ?></li>
                <li ><?php echo $html->link('Add Notice Board', '/admin/notices/notice_add'); ?></li>
                <li ><?php echo $html->link('View Notice Board', '/admin/notices/notice_view'); ?></li>
			...
			<li class="<?php echo $secondClass =isset($secondClass) ? $secondClass : ''; ?>"><a style="background-position: 0px 0px;" class="top-level" href="#">Schools <span>&nbsp;</span></a>
			  <ul style="display: none;">
				...
				<li><?php echo $html->link('Add Upcoming Schools', array('controller'=>'schools','action'=>'upcoming_add','admin'=>'true')); ?></li>
				<?php /*?><li><?php echo $html->link('View Users', '/admin/members/view'); ?></li><?php */?>
				<li><?php echo $html->link('View Upcoming Schools', array('controller'=>'schools','action'=>'upcoming_view','admin'=>'true')); ?></li>
           ...
           <?php /*?> FOR THE  SCHOOL ADMINISTRATOR <?php */?>
			...
			<li class="<?php echo $secondClass =isset($secondClass) ? $secondClass : ''; ?>"><a style="background-position: 0px 0px;" class="top-level" href="#">Schools <span>&nbsp;</span></a>
			  <ul style="display: none;">
				<li>
					<?php echo $html->link('Edit School', array('controller'=>'schools','action'=>'edit_assign_school',$session->read('Admin.school_id'),'admin'=>'true')); ?>
				</li>
				<li>
					<?php echo $html->link('Add Courses', array('controller'=>'schools','action'=>'add_assign_course','admin'=>'true')); ?>
				</li>
                <li>
					<?php echo $html->link('View Courses', array('controller'=>'schools','action'=>'view_assign_course','admin'=>'true')); ?>
				</li>
			  </ul>
			</li>
           ...
           <li><?php echo $html->link('View Payments', array('controller'=>'payment_histories','action'=>'salesreport','admin'=>'true')); ?></li>
             <li><?php echo $html->link('View Cause Withdrawal', array('controller'=>'payment_histories','action'=>'non_profit_withdrawal','admin'=>'true')); ?></li>
			<li><?php echo $html->link('View Tutor Withdrawal', array('controller'=>'payment_histories','action'=>'tutor_withdrawal','admin'=>'true')); ?></li>
			 ...
			 <li><?php echo $html->link('Student Fund', array('controller'=>'payment_histories','action'=>'student_fund','admin'=>'true')); ?></li>
              ...
              <li><?php echo $html->link('Minimum Wage', array('controller'=>'payment_histories','action'=>'minimum_wage','admin'=>'true')); ?></li>
              
              <li><?php echo $html->link('Twiddla Api', array('controller'=>'payment_histories','action'=>'twiddla','admin'=>'true')); ?></li>
              
              <li><?php echo $html->link('Parent Fund', array('controller'=>'payment_histories','action'=>'parent_fund','admin'=>'true')); ?></li>
              <li><?php echo $html->link('Parent Add Fund', array('controller'=>'payment_histories','action'=>'parent_add_fund','admin'=>'true')); ?></li>
            ...
            <ul style="display: none;">
				...
				<li><?php echo $html->link('Schools Requests', array('controller'=>'members','action'=>'school_requests','admin'=>'true')); ?></li>
             </ul>
              </li>

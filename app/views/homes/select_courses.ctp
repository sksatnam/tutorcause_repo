...
$('.delete').live("click",function() {
 ...
 $("#TutCourseSchoolinfoForm").validate({  
		...
		$('.deleteRow').click(function(){
			...
			$.ajax({
			   type: "POST",
			   url: ajax_url+"/homes/deletecourse",
...
<?php 	echo $this->Session->flash(); ?>
           ...
           <?php
			...
			echo $form->create('TutCourse',array('url'=>array('controller'=>'homes','action'=>'addcourse', $tutcources[0]['TutCourse']['id']),'id'=>'TutCourseSchoolinfoForm')); ?>   
						...
						?>   
						   <div class="stepFormRow" id="content">
                                  ...
                                  <td>
                                    ...
                                    <?php $set_course = $this->Session->read('courses');
									
										  $set_rate = $this->Session->read('rates');	
									?>
									
                                   
                                    <div class="ausu-suggest">
              							<input type="text" size="25" value="<?php if(isset($set_course)){echo $set_course;}else{ echo $tutcource['TutCourse']['course_id'];}?>" name="data[TutCourse][course_id][]" id="ad<?php echo $m;?>" rel="<?php echo $m;?>" class="valids alpha_num only_course required" autocomplete="off" style="z-index:10;" />
                                    ...
                                    <label class="AddCorLabel">Rate Per Hour:<span class="red" ><b>*</b></span></label>
                                        ...
                                        ?>
                                        <input class="textInStepFrm AddCorInput required number  valids " <?php echo $max_valid;?> value="<?php if(isset($set_rates)){ echo $set_rates;}else{printf("%.2f",  $tutorcourse1);}?>" type="text" id="rt<?php echo $m;?>" name="data[TutCourse][rate][]"  />
                                 ...
                                 <tr>
                                  <td>
                                   <?php $set_course = $this->Session->read('courses');
                                    ...
                                    <div class="ausu-suggest">
              							<input type="text" size="25" value="<?php if(isset($set_course)){echo $set_course;}?>" name="data[TutCourse][course_id][]" rel="<?php echo $universalCounter;?>"
                                    ...
                                    $tutorcourse1 = $tutcource['TutCourse']['rate'];
									?>
                                    <input class="textInStepFrm AddCorInput required number  valids " <?php if(isset($set_rate)){echo $set_rate;}else{echo $max_valid;}?> value="<?php if(isset($set_rate)){echo $set_rate;}else{ printf("%.2f",  $tutorcourse1);}?>"  id="rt<?php echo $universalCounter;$universalCounter++;?>" type="text" name="data[TutCourse][rate][]"  />

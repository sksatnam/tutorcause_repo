<?php //3aug2012 ?><script src="http://maps.google.com/maps/api/js?sensor=false" type="text/javascript"></script>
	...
	$("#contactusform").validate({
		...
		messages:
		{
			"data[ContactUsMessage][first_name]":
			{
				...
				maxlength:"Please enter less then 20 character"
			},
			"data[ContactUsMessage][last_name]":
			{
                ...
                <!--Contact Left Column Begin Here-->
                    ...
                    <div id="contact-right">
                       ...
                       <?php /*?> <div class="info-row">
                        ...
                        <div class="info-row">
                            <h3>E-mail:</h3>
                            <p><a href="mailto:support@tutorcause.com">support@tutorcause.com</a></p>
                        </div>

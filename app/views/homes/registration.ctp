           ...
           <input type="hidden" name="data[Member][email]" id="facebook_email" value="" />
            ...
            <?php */?>
				...
				<div class="stepFormThird">
                        ...
                        <div class="input text"><label for="userMetaFname"><b>First Name:<span class="red">*</span></b></label><input type="text" id="userMetaFname" class="textInStepFrm required letters" name="data[userMeta][fname]" value="<?php if($this->Session->read('Member.fname'))
						{
                        ...
                        <div class="input text"><label for="userMetaLname"><b>Last Name:<span class="red">*</span></b></label><input type="text" id="userMetaLname"  class="textInStepFrm field required letters" name="data[userMeta][lname]" value="<?php if($this->Session->read('Member.lname'))
						{
                        ...
                        <?php /*?><div class="stepThreeFormRow">
                            <label><b>Time Zone:<span class="red">*</span></b></label>
                            <select id="timezone" class="selectStepFrm required" name="data[Member][timezone]">
                        ...
                        <?php
						if($this->Session->read('Member.group_id')!='9')
						{
						?>
                       ...
                       <div class="stepThreeFormRow">
						...
						<div class="stepThreeFormRow" style="min-height:25px;">
							<h2><span style="color: rgb(33, 158, 218); opacity: 0.4; font-size: 18px; float:left;">Optional Information</span><span style="font-size: 10px; opacity: 12 ! important; float: left; color: rgb(27, 143, 216); padding-top: 6px; cursor:pointer;" id="optional">(Show)</span></h2>
						</div>
			...
			<?php /*?>		
					...
					?><?php */?>
                         ...
                         <div class="stepThreeFormRow">
                           <input type="checkbox" name="tos" value="1" class="required" style="margin-top:10px; float:left;" />
                          <label style="width:330px;"><b style="margin-left:6px;">I agree to the TutorCause <a href="<?php echo HTTP_ROOT;?>homes/terms_of_service" style="color: #1B8FD8; text-decoration:underline;" target="_blank">Terms of Service</a></b></label>
			              </div>

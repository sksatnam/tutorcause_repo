...
/*	$('#calendar1').datepicker({
	...
	*/	  
				...
				var url = '<?php echo HTTP_ROOT;?>homes/selectaddevent';
		...
		*/
		...
		events: [<?php 
			...
			?>	
				 {
					...
					start: '<?php echo $te[0]['start_date'];?>',
					end: '<?php echo $te[0]['end_date'];?>',
					allDay: false,
					<?php 
			...
			eventResize: function(event,dayDelta,minuteDelta,revertFunc) {
				...
				var editurl = '<?php echo HTTP_ROOT;?>homes/selecteditevent';
	...
	$('#editsch').dialog({
        ...
        buttons: {
			"Save": function() {
				...
				var editEventUrl = '<?php echo HTTP_ROOT;?>homes/editschedule';
...
<?php //	echo $this->Session->flash(); ?>
              ...
              <div id="tutor-wrap">
                ...
                <input type="button" name="" value="Apply" class="fund-btn" onclick="javascript:location.href='<?php echo HTTP_ROOT?>homes/settutorsession'"/>
                
                <?php /*?>      
                <div class="button">  
                <span></span>
                <a href="<?php echo HTTP_ROOT.'homes/settutorsession';?>"><input type="button" value="Start Tutoring" /></a>
                </div>  <?php */?>
              ...
              <div class="instruction_msg"><h2>To set your availability for tutoring, just click on the day and time and drag your mouse</h2></div> 
              
              
              <?php /*?><div class="stepsHeadingNew">
<?php
if(!isset($profile))
{
?>              
                        <div class="newProgressBarOuter">
                        	<div class="proBarsSection1">
                                ...
                                <span class="spanOnHover">Basic Information</span>

                            </div>
                            <div class="proBarsSection1">
                            	<span class="spanNo">2</span>
                                <span class="spanOnHover">Select Courses</span>
                            </div>
                            <div class="proBarsSection2">
                            	<span class="spanNo">3</span>
                                <span class="spanOnHover">Set Availability</span>
...
?>
  					<!--	 <div class="stepFormContButton button">  
                    	<span></span>
<input type="button" value="Copy Schedule" class="getdate" onClick="copysch();"/>
                        </div>-->
                </div><?php */?>    
	...
	<div class="row-1" style="font-size:14px;">
        ...
        <tr>
         <td><input type="checkbox" name="allday" onclick="checkallday();" id="allday"  /><span>All day</span> </td>
			...
			<form id="copyschedule" name="copyschedule" action="<?php echo HTTP_ROOT.'homes/copyschedule'?>" enctype="multipart/form-data" method="post" >
			<tbody class="daily">
		...
		<!--	<tr>
			...
			<form id="copyschedule2" name="copyschedule2" action="<?php echo HTTP_ROOT.'homes/copyweek'?>" enctype="multipart/form-data" method="post" >

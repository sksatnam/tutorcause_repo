...
<div id="content-wrap"  class="fontNew">
  ...
  <div id="tutor-wrap"> 
    ...
    <?php foreach($approvalAwaiting as $result){?>
			<div class="dp_main">
				<div class="dp_img">
					<?php
					if($result['tutor']['showImage'])
					{
						...
						if(!empty($result['tutor']['image_name'])){
							echo $html->image("members/thumb/".$result['tutor']['image_name']);
						} else {
				...
				<div class="dp_right">
					...
					<div class="dp_info">
                        ...
                        <li class="dp_name">
                         ...
                         <?php echo $html->link($tutorname ,array('controller'=>'members', 'action'=>'tutor', $urltutor), array('title' => $result['tutor']['fname'] ,'style'=>'color:#1D5894'));?>  
                        </li>
						...
						<?php /*?>	<li><b>Location:</b> 
							<?php
							if(!empty($result['tutor']['userMeta']['city']) && !empty($result['tutor']['userMeta']['state']))
							{
								echo $result['tutor']['userMeta']['city']." , ".$result['tutor']['userMeta']['state'];
                            }
							else
							{
								echo 'N/A';
					...
					<?php echo $this->Form->create('Member',array('class'=>'form1')); ?>
					<div class="dp_action">
						...
						<input type="hidden" class="studentName" value="<?php echo $result['tutor']['fname']." ".$result['tutor']['lname'];?>" />

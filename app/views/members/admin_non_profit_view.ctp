  ...
  <div id="content">
	...
	<div id="mid-col">    	
		<div class="box">
			...
			<?php //pr($this->data);?>
				<?php echo $form->create('member',array("url" => $html->url(array('action'=>'non_profit_view',"admin" => true), true)));?>
...
<input type="reset" value="Reset"  style=" width:100px; margin-left:20px; background-color:#B3BBC2; color:#FFFFFF" />
			...
			<?php echo $form->end(); ?>	
            	...
            	<div style="-moz-border-radius-bottomleft: 5px;-moz-border-radius-bottomright: 5px;" class="box-container rounded_by_jQuery_corners">
					...
					<?php echo $form->input('pagingStatus',array('type' => 'hidden','value'=>HTTP_ROOT.'admin/members/non_profit_view/page:1','id' => 'pagingStatus')); ?>
					&nbsp;&nbsp; <b>Icons used :</b>	

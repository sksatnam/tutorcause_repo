...
<?php	echo $this->Session->flash(); ?>
    ...
    <?php  echo $this->element('frontend/tutorProfile'); ?>
        <div class="public_profile_cointainer_IInd" style="width:710px">
			...
			<li><a href="#usage"> Non-Profit</a></li>
        ...
        <h2 style="color:#219eda; font-size:32px;">Non-Profit</h2>
          ...
          <?php foreach($causeResult as $result){?>
			<div class="dp_main">
				...
				<div class="dp_right">
					<div style="padding:0px 2px;margin:0px 12px;font-weight:bold;font-size:14px"><?php
					
					 $findname = $result['Cause']['userMeta']['cause_name'];
					 $urlName=$findname . '_' . $result['Cause']['id'];
					 ?>
					   <label class="tutorSearchResult-name-disc2"><?php 
					   if(!empty($findname))
					   {

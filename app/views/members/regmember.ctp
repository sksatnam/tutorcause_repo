    ...
    <div id="tutor-wrap"> 
		...
		<!--		<div style="margin-left:10px;width:184px;">-->
				...
				<!--	<div class="userUploadImg" style="border:1px solid #ACDFFB;width:auto;padding:1px;max-width:184px;">-->
                    ...
                    <?php if($this->Session->read('Member.group_id')==7 || $this->Session->read('Member.group_id')==8 || $this->Session->read('Member.group_id')==9)
					{
					?>	
                   ...
                   <style type="text/css">
                   .accordiancontainrers{ float:left; width:100%;}
                   
                   </style>
                   <div class="accordiancontainrers">
                   
                   <div id="accordian" style="width:100%;">
        <div class="container" style="width:100%;">
          <h2 class="acc_trigger active" style="width:100%;"><a href="#">Account settings</a></h2>
          <div style="display: block; width:100%;" class="acc_container">
            <div class="block">
			      	...
			      	<?php echo $form->input('userMeta.cause_name',array('label'=>'<b>Cause Name:<span class="red" >*</span></b>','class'=>'textInStepFrm field required','maxlength'=>75));?>
                        ...
                        <div class="stepThreeFormRow">
                            ...
                            <select id="timezone" class="selectStepFrm required" name="data[Member][timezone]">
                                ...
                                {
                                ?>	
                                    <option value="<?php echo $at['Timezone']['id'];?>"
                                    <?php
                                    if($this->data['Member']['timezone']==$at['Timezone']['name'])
									echo "selected=\"selected\"";
									?> ><?php echo '&nbsp;('.$at['Timezone']['GMT'].') '.$at['Timezone']['name'];?></option>	

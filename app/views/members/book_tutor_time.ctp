...
<div class="stepsHeadingNew">
                ...
                <?php /*?>  <div class="instruction_msg"><h2>To set your availability for tutoring, just click on the day and time and drag your mouse</h2></div> <?php */?>
				...
				<th align="left" >
                 ...
                 <?php 
					foreach($tutorcourse as $tc)
					{
						...
						{
							 $Dec_rate=($tc['TutCourse']['rate']+(($tc['TutCourse']['rate']*$charge['Charge']['tutorcause_charge'])/100));
						
						?>
                                            <option value="<?php echo $tc['TutCourse']['id'].'_'.$Dec_rate;?>" selected="selected"><?php echo $tc['TutCourse']['course_id'];?></option>
                     	<?php	
						}
						else
						{
							 $Dec_rate=($tc['TutCourse']['rate']+(($tc['TutCourse']['rate']*$charge['Charge']['tutorcause_charge'])/100));
						?>	
                                        <option value="<?php echo $tc['TutCourse']['id'].'_'.$Dec_rate;?>" ><?php echo $tc['TutCourse']['course_id'];?></option>
						<?php	
						}

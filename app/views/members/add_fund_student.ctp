...
<div id="content-center">
                      <?php echo $this->Session->flash(); ?>
                   	    <div id="content-wrap">
                            	...
                            	<h1>Add Student Funds</h1>
                                
                                <?php echo $form->create('Member', array("url" => $html->url(array('action'=>'parent_fund_student'), true),'id'=>'stripepayment')); ?>
                                
                                
                               <?php /*?><form name="form1" method="post" action="<?php echo HTTP_ROOTS.'members/parent_fund_student';?>" id="stripepayment"><?php */?>
                                
                                <input type="hidden" name="studentid" value="<?php echo $mystudent['Member']['id'];?>" />
                                    ...
                                    <?php echo $cms_add_fund_data['Page']['body']; ?>
                                        ...
                                        <div id="add-form-wrap">
                                            ...
                                            <div class="element">
                                                <label>
                                                <b>
                                              Student Name:<span class="red" >*</span></b></label>
                                                <input type="text" name="studentname" size="30" maxlength="30" class="lettersonly required" value="<?php echo $mystudent['Member']['fname'].' '.$mystudent['Member']['lname'];?>" >
                                            </div>

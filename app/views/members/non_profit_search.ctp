...
.dp_main{margin:15px 10px 15px 10px;border:1px solid #A0D7F3;background-color:#FAFDFE}
	...
	.tutorSearchResult-name{ width:530px;}
	.tutorSearchResult-name-disc2{ width:340px;}
...
<div id="search">
    ...
    <form name="causesearch" id="causesearch" action="<?php echo HTTP_ROOT.'members/non_profit_search';?>" method="post" >

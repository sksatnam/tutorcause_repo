		...
		*/
          ...
          Stripe.setPublishableKey('pk_5ZTUjQ4Rbv6SPmSs5HPSvfTXOOevl');
            $(document).ready(function() {
                      ...
                      <?php echo $this->Session->flash(); ?>
                   	    <div id="content-wrap">
                            	...
                            	<h1>Add Funds</h1>
                                     ...
                                     <?php echo $form->create('Member', array("url" => $html->url(array('action'=>'parent_stripe_sucess'), true),'id'=>'example-form')); ?>
                                
                              <?php /*?>  <form name="form1" method="post" action="<?php echo HTTP_ROOTS.'members/parent_stripe_sucess';?>" id="example-form">  <?php */?>
			  ...
			  if($this->Session->read('Member.memberid'))
			   {
				 echo $parentdata['Member']['fname'].' '.$parentdata['Member']['lname'];   
			   }
              ?>" >
                                            </div>
											<?php

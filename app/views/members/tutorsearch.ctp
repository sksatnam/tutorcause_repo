...
$(document).ready(function(){
			...
			$("div.searching").live("mouseenter",function() {
														  
				if($(this).attr('class').indexOf('current')<0)
				{
					$(this).find('.cost').addClass('cost2');  
					$(this).find('.cost').removeClass('cost');  
				}
				...
				if($(this).attr('class').indexOf('current')<0)
				{
					$(this).find('.cost2').addClass('cost');  
					$(this).find('.cost2').removeClass('cost2');  
				}
				...
				<div id="search-wrap">
                    ...
                    <div id="availability">
                        ...
                        <ul>
                         ...
                         <img src="<?php echo FIMAGE.'help-icon.png';?>" width="19" height="19" />

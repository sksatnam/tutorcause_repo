...
<input type="hidden" name="pagingStatus" id="pagingStatus" value="<?php echo HTTP_ROOT.'members/designsearch/page:1';?>"  />
        	...
        	<div id="content-wrap">
               <?php	echo $this->Session->flash(); ?>
				...
				<div id="tutor-wrap"> <!--Cause Search Begin Here-->
                  ...
                  <form name="tutorsearch" id="tutorsearch" action="<?php echo HTTP_ROOT.'members/designsearch';?>" method="post" >

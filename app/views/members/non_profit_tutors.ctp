...
<?php	echo $this->Session->flash(); ?>
			...
			<div class="dp_main">
            	...
            	<div style="padding:0px 2px;margin:0px 2px;font-weight:bold;font-size:14px"><?php
					...
					$urlName=$urlName . '_' . $result['Member']['id'];
					 ...
					 ?>
					   <label class="tutorSearchResult-name-disc2" style="padding-left:10px;"><?php 
					   
					   if(!empty($findname))
					   {
					   	echo $html->link($findname, array('controller'=>'members', 'action'=>'tutor', $urlName), array('title' => $findname,'target' => '_blank' ));
					   }
					   else
					   {
						echo 'N/A';
					...
					<div class="dp_info">
						<ul>
                            ...
                            <?php
							if(!empty($result['Member']['facebookId']))
							{
							?>

                    ...
                    <div class="paddinSet">
						   <fieldset style="margin:0px; float:left;" id="personal-info">
                            ...
                            <label class="dpkLab" for="UserFirstname" class="field-title">Email : </label><?php echo $form->input('Member.email',array('label'=>'','div' => '','class'=>'required','value'=>$admindata['Member']['email'])); ?><br /><br />
                              ...
                              <?php
							    if($admindata['Member']['group_id']==8 || $admindata['Member']['group_id']==9)
								{
                            ...
                            <br/>
								...
								?>
                                <label for="UserCity" class="dpkLab">Accrued Amount :</label><?php echo $form->input('Member.balance',array('label'=>false,'id'=>'UserCity','class'=>'number','readonly'=>'true','value'=>$admindata['Member']['balance'])); ?>
                            <br/>
                                ...
                                <label class="dpkLab" for="UserFirstname" class="field-title">Stripe Id : </label><?php echo $form->input('Member.stripeid',array('label'=>'','div' => '','class'=>'','value'=>$admindata['Member']['stripeid'],'readonly'=>'readonly')); ?><br /><br />

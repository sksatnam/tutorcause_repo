...
<div id="content">
	...
	<div id="mid-col">    	
		<div class="box">
			...
			<?php /*?>	<br /><br /><label><?php echo $this->data['EmailTemplate']['title']; ?> </label>
    ...
    <!--        <textarea rows="30" cols="20">fjkdsjfkljsdklf
            </textarea>
            ...
            -->
				...
				<div align="center">
					...
					<?php  echo $form->textarea('EmailTemplate.html_content',array('rows'=>40,'class'=>'tinymce','label'=>'','div' => 'entryField')); ?>
				</div><br />
			</div>

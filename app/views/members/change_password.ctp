...
<?php	echo $this->Session->flash(); ?>
  ...
  <div id="tutor-wrap"> 
    ...
    <div class="msg-form" style="width:406px; padding-left:20px; padding-top:20px;">
     
    
    <?php echo $form->create('Member',array("id"=>"MemberChangePassword",'url' => '/members/change_password')); ?>
    
    <div class="forgotEmailOutr" style="width:370px;">
    	<label style="width:130px;">Password:</label>
        <div style="width:240px; float:left;">
        <input autocomplete="off" type="password" name="data[Member][pwd]" id="userPassword" value="" class="required" style="width:200px;"/>
        </div>
    </div>
    
    
    <div class="forgotEmailOutr" style="width:370px;">
    	<label style="width:130px;">Confirm Password:</label>
        <div style="width:240px; float:left;">
        <input autocomplete="off" type="password" name="data[Member][cPassword]" value="" class="required" style="width:200px;"/>
        </div>
    </div>
    
    <div class="forgotPasswrdButton button" style="margin-left:128px;">
          <span></span>

						   ...
						   <div class="stepFormRow" id="content">
                                  ...
                                  <td>
                                    ...
                                    <div class="ausu-suggest">
              							<input type="text" size="25" value="<?php echo $tutcource['TutCourse']['course_id']?>" name="data[TutCourse][course_id][]" id="ad<?php echo $m;?>" rel="<?php echo $m;?>" class="valids alpha_num required" autocomplete="off" style="z-index:10;" />
                                 ...
                                 <tr>
                                  <td>
                                    ...
                                    <div class="ausu-suggest">
                                        ...
                                        id="ad<?php echo $universalCounter;?>" class="valids alpha_num" autocomplete="off" style="z-index:10;"/>

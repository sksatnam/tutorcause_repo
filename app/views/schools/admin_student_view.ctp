  ...
  <div id="content">
	...
	<div id="mid-col">    	
		<div class="box">
            	...
            	<h4 style="-moz-border-radius-topleft: 5px;-moz-border-radius-topright: 5px;" class="white rounded_by_jQuery_corners">View Student<a href="javascript:void(0);" class="expandGrid">SHRINK GRID</a></h4>
			...
			<?php //pr($this->data);?>
				<?php echo $form->create('member',array("url" => $html->url(array('action'=>'student_view',$schoolid,"admin" => true), true)));?>
						<table class="table-filter" style="width: 100%; float: left; border-bottom: 2px solid;">
							<tr class="">
								...
								<?php /*?><td style="text-align:left; padding-left:10px; "><?php echo $form->select('active',array(''=>'All','1'=>'Active','0'=>'De-Active'),null,array(),false); ?></td><?php */?>
                                 <td style="text-align:left; padding-left:10px;">
                                    ...
                                    <option value="1" <?php  
									if(isset($_SESSION['tutorview']['active'])){
										echo ($_SESSION['tutorview']['active']=="1")?'selected="selected"':'';
									}
									?>>Active</option>
                                    <option value="0"  <?php  
									if(isset($_SESSION['tutorview']['active'])){
										echo ($_SESSION['tutorview']['active']=="0")?'selected="selected"':'';
									}
									?>>De-Active</option>
                            ...
                            <tr class="">
								<td style="text-align:right;" class=""><b>Tutor Address :</b></td>
...
<input type="reset" value="Reset"  style=" width:100px; margin-left:20px; background-color:#B3BBC2; color:#FFFFFF" />
			...
			<?php echo $form->end(); ?>	
            	...
            	<div style="-moz-border-radius-bottomleft: 5px;-moz-border-radius-bottomright: 5px;" class="box-container rounded_by_jQuery_corners">
					...
					<?php echo $form->input('pagingStatus',array('type' => 'hidden','value'=>HTTP_ROOT.'admin/schools/tutor_view/page:1','id' => 'pagingStatus')); ?>
					&nbsp;&nbsp; <b>Icons used :</b>	
					<?php echo $html->image('icon-edit.gif');?>Edit &nbsp;&nbsp;&nbsp;
					<?php echo $html->image('icon-delete.gif');?>Delete &nbsp; &nbsp;&nbsp;
                    
                    <div align="right"><?php echo $html->link("Export to Excel",array('controller'=>'schools', 'action'=>'exportstudentcsv',$schoolid,'admin' => true)); ?></div>
				...
				<div class="box">
						...
						<div id="pagingDivParent">
							<?php echo $this->element('adminElements/schools/viewtutor'); ?>
						</div>

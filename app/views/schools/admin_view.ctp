	...
	$(document).ready(function() {
		...
		function likeUnlike(type,elementId){
		  ...
		  $.ajax({
			  ...
			  data: "&type="+type,
			  success: function(msg){
				  if($.trim(msg) == "activated"){
					  element.hide();
					  element.next().show();
				  } else if($.trim(msg) == "deactivated"){
					  element.hide();
					  element.prev().show();
				  }
			  }
  ...
  <div id="content">
    ...
    <div class="box">
		 ...
		 <?php echo $this->Form->create('School', array("url" => $html->url(array('action'=>'view',"admin" => true), true))); ?>
...
<input type="reset" value="Reset"  style=" width:100px; margin-left:20px; background-color:#B3BBC2; color:#FFFFFF" />
            ...
            <div style="-moz-border-radius-bottomleft: 5px;-moz-border-radius-bottomright: 5px;" class="box-container rounded_by_jQuery_corners">
					...
					<?php echo $form->input('pagingStatus',array('type' => 'hidden','value'=>HTTP_ROOT.'admin/schools/view/','id' => 'pagingStatus')); ?>
					&nbsp;&nbsp; <b>Icons used :</b>	
					<?php echo $html->image('icon-edit.gif');?>Edit &nbsp;&nbsp;&nbsp;
					<?php echo $html->image('icon-delete.gif');?>Delete &nbsp; &nbsp;&nbsp;
                    <?php echo $html->image('icon-view.gif');?>Course View &nbsp; &nbsp;&nbsp; 
                    <?php if($session->read('Admin.group_id')=='1')
						{ ?>
                    <?php echo $html->image('student_icon.png');?>Student View &nbsp; &nbsp;&nbsp;
                    <?php echo $html->image('tutor_icon.png');?>Tutor View &nbsp; &nbsp;&nbsp;
                    <?php } ?>
				...
				<?php echo $this->Session->flash(); ?>
						...
						<div id="pagingDivParent">
							<?php echo $this->element('adminElements/schools/viewschool'); ?>
						</div>

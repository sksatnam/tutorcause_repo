  ...
  <div id="content">
	...
	<div id="mid-col">    	
		<div class="box">
		 ...
		 echo $this->Form->create('school', array('action'=>'course_view/'.$id,'admin'=> true )); ?>
...
<input type="reset" value="Reset"  style=" width:100px; margin-left:20px; background-color:#B3BBC2; color:#FFFFFF" />
			...
			<div style="-moz-border-radius-bottomleft: 5px;-moz-border-radius-bottomright: 5px;" class="box-container rounded_by_jQuery_corners">
					...
					<?php echo $form->input('pagingStatus',array('type' => 'hidden','value'=>HTTP_ROOT.'admin/schools/all_course_view/'.$id,'id' => 'pagingStatus')); ?>
				&nbsp;&nbsp; <b>Icons used :</b>	
				...
				<div class="box">
						...
						<div id="pagingDivParent">
							<?php echo $this->element('adminElements/schools/viewcourse'); ?>
						</div>

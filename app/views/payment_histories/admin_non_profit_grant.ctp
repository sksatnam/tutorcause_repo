	  	...
	  	<div id="mid-col">    	
		   ...
		   ?>	   
               ...
               <table class="table-filter" style="border-bottom-width:1px; width:100%; float:left;" border="0">
						...
						?>	
                        <tr class="">
							<td class="col-chk2"><b><?php echo $cd['Member']['userMeta']['cause_name']?></b></td>
							<td class="col-chk2"><b><?php echo $cd['Member']['email']?></b></td>
							<td class="col-chk2"><b><?php echo $cd['TutorToCause']['cause_grant'].' %'?></b></td>
							<td class="col-chk2" style="font-size:12px; color: #C00;"><b><?php 
							$actualcausegrant =  $cd['TutorToCause']['cause_grant']/100;

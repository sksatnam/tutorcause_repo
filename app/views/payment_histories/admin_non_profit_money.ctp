...
<div id="content">
    ...
    <h2>Payment</h2>
      ...
      <?php echo $this->element('adminElements/left-sidebar'); ?>
	  	<div id="mid-col">    	
			<div class="box">
				<h4 style="-moz-border-radius-topleft: 5px;-moz-border-radius-topright: 5px;" class="white rounded_by_jQuery_corners">Non-Profit withdrawal</h4>
				<div id="userAddPanel" style="float:left; width:735px;">
                    ...
                    <div class="paddinSet">
                         ...
                         <?php echo $form->create('payment_histories', array('action' => 'approve_non_profit_withdrawal','admin'=> true,'id'=>'approveCauseWithdrawal')); ?>
           ...
           <input type="hidden" name="paypaltutornotes" id="paypaltutornotes" value=""  />
				...
				<?php
					$url = HTTP_ROOT.'members/paypal_non_profit/'.$withdrawalid;
				?>

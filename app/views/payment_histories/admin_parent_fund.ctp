...
<div id="content">
	...
	<div id="mid-col">
		<div class="box">
			<h4 style="-moz-border-radius-topleft: 5px;-moz-border-radius-topright: 5px;" class="white rounded_by_jQuery_corners">Parent Fund<a href="javascript:void(0);" class="expandGrid">EXPAND GRID</a></h4>
			<div id="userAddPanel">
				...
				<div class="slide" style="background-color:#F1F1F1;">
                	<?php echo $this->Form->create('payment_histories', array("url" => $html->url(array('action'=>'parent_fund',"admin" => true), true))); ?>
				...
				<div style="-moz-border-radius-bottomleft: 5px;-moz-border-radius-bottomright: 5px;" class="box-container rounded_by_jQuery_corners">
					<?php echo $form->input('pagingStatus',array('type' => 'hidden','value'=>HTTP_ROOT.'admin/payment_histories/parent_fund/','id' => 'pagingStatus')); ?>
					...
					<div class="box">
						<div id="pagingDivParent">
							<?php echo $this->element('adminElements/payments/parent_fund'); ?>
						</div>
					</div>
				</div>
			</div>

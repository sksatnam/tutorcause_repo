<?php //3aug2012 ?><?php //3aug2012 ?>
  ...
  <div id="content">
    ...
    <div class="box">
        	...
        	<h4 style="-moz-border-radius-topleft: 5px;-moz-border-radius-topright: 5px;" class="white rounded_by_jQuery_corners">Tutor Withdrawal<a href="javascript:void(0);" class="expandGrid">EXPAND GRID</a></h4>
		 ...
		 <?php echo $this->Form->create('payment_histories', array("url" => $html->url(array('action'=>'tutor_withdrawal',"admin" => true), true))); ?>

						<table class="table-filter" style="width: 100%; float: left; border-bottom: 2px solid;">
							<tr class="">
								<td style="text-align:right;" class=""><b>From Date :</b></td>
								<td style="text-align:left; padding-left:10px; "> <?php echo $form->input('TutorWithdrawal.dateFrom',array('id'=>'DateFrom','label'=>false, 'class'=>'datepicker')); ?></td>

                                <td style="text-align:right;" class=""><b>To Date :</b></td>
								<td style="text-align:left; padding-left:10px; "> <?php echo $form->input('TutorWithdrawal.dateTo',array('id'=>'DateTo','label'=>false, 'class'=>'datepicker')); ?></td>
                            ...
                            <tr class="">
                                ...
                                <td style="text-align:right;" class=""><b>Tutor email :</b></td>
								<td style="text-align:left; padding-left:10px; "> <?php echo $form->input('TutorWithdrawal.email',array('id'=>'email','label'=>false,)); ?></td>
                            
                                	<td style="text-align:right;" class=""><b>Results Per Page :</b></td>
								<td style="text-align:left; padding-left:10px; "><?php echo $form->select('TutorWithdrawal.perpage',array('5'=>'5','10'=>'10','20'=>'20','30'=>'30','50'=>'50','100'=>'100'),null,array("id"=>'perpage'),false); ?> </td>
...
<input type="reset" value="Reset"  style="width:100px; margin-left:20px; background-color:#B3BBC2; color:#FFFFFF" />
            ...
            <div style="-moz-border-radius-bottomleft: 5px;-moz-border-radius-bottomright: 5px;" class="box-container rounded_by_jQuery_corners">
					...
					<?php echo $form->input('pagingStatus',array('type' => 'hidden','value'=>HTTP_ROOT.'admin/payment_histories/tutor_withdrawal/','id' => 'pagingStatus')); ?>
				...
				<div class="box">
						...
						<div id="pagingDivParent">
							<?php echo $this->element('adminElements/payments/tutor_withdrawal'); ?>
						</div>

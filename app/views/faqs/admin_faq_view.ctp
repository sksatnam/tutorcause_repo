<?php //3aug2012 ?><script type="text/javascript">
  ...
  <div id="content">
    ...
    <div class="box">
        	...
        	<h4 style="-moz-border-radius-topleft: 5px;-moz-border-radius-topright: 5px;" class="white rounded_by_jQuery_corners">View Faq<a href="javascript:void(0);" class="expandGrid">SHRINK GRID</a></h4>
			...
			<table class="table-filter" style="width: 100%; float: left; border-bottom: 2px solid;">
							<tr class="">
                               ...
                               <?php */?>
                                    ...
                                    <option value="9"  <?php  
									if(isset($_SESSION['faqview']['group_id'])){
										echo ($_SESSION['faqview']['group_id']=="9")?'selected="selected"':'';
									}
									?>>Parent</option>

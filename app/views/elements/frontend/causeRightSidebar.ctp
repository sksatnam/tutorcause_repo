<script type="text/javascript">
	...
	function checkupdategoal()
	{
		...
		if(goal=='')
		{
			document.getElementById('cuserrorMsg').innerHTML = 'Please enter goal amount.';
		//	alert('Please enter goal amount.')	
			return false;
		}
		
	 								
		var url = '<?php echo HTTP_ROOT;?>members/update_amount_raised';
		$.ajax({
			type: "GET",
			url: url,
			data: '&goal='+goal,
			success: function(msg){
				...
				{
					document.getElementById('cuserrorMsg').innerHTML = 'Please enter only number.';
	...
	function clearcusMsg()
	{
		document.getElementById('cuserrorMsg').innerHTML = '';
	}
        ...
        <div class="fundraising">
            <div class="fundraising-wrap">
                ...
                <div style="width: 1px; height: 1px; overflow: hidden; clear: both;">
                   ...
                   <?php /*?>         <form method="post" action="<?php echo HTTP_ROOT.'members/update_amount_raised';?>" name="updateGoal" id="updateGoal" ><?php */?>
                                <table width="100%" border="0" cellpadding="1" cellspacing="0">
                                <tbody><tr>
                                <td style="padding: 0pt 5px;">Goal:</td></tr>
                                <tr><td style="padding: 0pt 5px;"><input name="data[cause][goal]"  id="goal" value="<?php echo $getBalance['userMeta']['goal'];?>" style="width: 132px;" type="text" maxlength="6" onkeypress="javascript:clearcusMsg();"></td>
                                
                                <tr><td style="padding: 0pt 5px; font-size:12px; color:#F00;" id="cuserrorMsg"></td>
...
<?php /*?>                                <input value="Update" class="therm-update" type="button" onclick="javascript:checkupdategoal();">
<?php */?>                                
                                <tr><td align="center"><div class="forgotPasswrdButton button" style="margin-left:22px; margin-top:8px;">
                                  <span></span>
                                  <input type="button" value="Update" class="therm-update" onclick="javascript:checkupdategoal();" />
                              </div>
      </td></tr>
                                </tbody></table>
                       <!--     </form>-->

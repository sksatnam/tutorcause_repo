<?php //3aug2012 ?>     <div class="public_profile_cointainer_IIIrd">
			<div style="border: 2px solid rgb(204, 204, 204); margin-bottom: 35px;">
				<div style="background-color: #168fd0; border-bottom: 2px solid rgb(204, 204, 204); color: rgb(238, 238, 238); font-family: verdana,tahoma,sans-serif; font-size: 14px; font-weight: bold; padding: 3px 15px; text-align: center;">Accrued Amount</div>
        	...
        	<div style="border: 2px solid rgb(204, 204, 204); margin-bottom: 35px;">
				...
				{
				?>
               <div style="margin:10px;text-align:center;"><a href="<?php echo HTTP_ROOT;?>members/get_statement" style="color:#1D5894">Withdrawal Request</a></div>
               <?php
				}
			   ?>
			</div>

...
function causewithreq()
{
	$('#causewithreq').dialog({
		...
		buttons: {
			"Send": function() {
					$(this).dialog("close");	
							var sendurl = '<?php echo HTTP_ROOT;?>members/non_profit_withdrawal';
...
function causewithreq1()
{
	$('#causewithreq1').dialog({
		autoOpen: true,
    ...
    <div class="left-sidebar">
      ...
      <div id="accordian">
          ...
          <div class="acc_container" style="display: none; ">
            <div class="block">
              <ul class="account-links" >
                ...
                <li><a href="<?php echo HTTP_ROOT.'members/non_profit_get_statement';?>">Payment History</a></li>
                <li><a href="<?php echo HTTP_ROOT.'members/non_profit_tutors';?>">My Tutors</a></li>
        ...
        <?php /*?>        <?php
                ...
                <li><a href="<?php echo HTTP_ROOT.'members/non_profit/'.$urlName;?>">Public Profile</a></li>   
                ...
                if(isset($pendingrequest))
					...
					{
						if($getBalance['Member']['creditable_balance']>0)
						{
							?> <li class="last"><a href="javascript:causewithreq();" >Withdrawal Request</a></li> <?php
						}
						else
						{
							?> <li class="last"><a href="javascript:causewithreq1();" >Withdrawal Request</a></li> <?php
						}
					}
                ?>
              </ul>
        ...
        <ul>
            ...
            {
				$tutorName = $tr['Member']['fname'].' '.$tr['Member']['lname'];
            ...
            <div class="profile-wrap">
              ...
              <?php
				...
				//	$countImg = count($tr['Member']['UserImage'])-1;
					if(!empty($tr['Member']['image_name'])){
						echo $html->image("members/thumb/".$tr['Member']['image_name'],array('width'=>57,'height'=>58));
					} else {
						?><img src="https://graph.facebook.com/<?php echo $tr['Member']['facebookId']; ?>/picture?type=large" width="57" height="58"  />
					<?php }
					}
					else
					{
              ...
              <div class="profile-info">
                <div class="name-price">
                  <h4 class="cause-name"><?php echo $tutorName;
				    ...
				    $tutor_raised = $this->requestAction('members/tutor_give_non_profit/'.$tr['TutorRequestCause']['tutor_id'].'/'.$tr['TutorRequestCause']['cause_id']); 
			...
			?>
              <li>
                   <p style="font-family: Myriad Pro; color: rgb(24, 73, 122); font-size: 16px; padding-left:13px; padding-top:33px;">
                   		There are currently no tutors for this non-profit
                   </p>
              </li>
...
<div id="causewithreq1" title="Dialog Title" style="display:none;">

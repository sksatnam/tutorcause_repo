      ...
      <div id="tutor-left">
        ...
        foreach($filtercause as $fc)
			...
			?>
			  ...
			  <li class="cause-bg">
              <div class="cuasesearching <?php if($watchcause['Member']['id'] == $fc['Member']['id']){ echo "causecurrent";}?>" onclick="JavaScript:showcause('<?php echo $fc['Member']['id'];?>');" >              
              
          <?php /*?>    <a href="JavaScript:void(0);" onclick="showcause(<?php echo $fc['Member']['id']; ?>);" 
				  ...
				  <div class="profile-info">
					<div class="name-price">
					  ...
					  <div class="amount-raised">
							...
							<div class="<?php if($watchcause['Member']['id'] == $fc['Member']['id']){ echo "raised-amt2";}else if($i == 1 && count($watchcause)==0 ){ echo "raised-amt2";}else{ echo "raised-amt";}?>">
                            <?php
						   		$amount_raised = $this->requestAction('members/non_profit_amount_raised/'.$fc['userMeta']['member_id']); 
						    ?>
		 ...
		 ?>
				  ...
				  <?php
							 ...
							 $urlName=$findname . '_' . $watchcause['Member']['id'];
						 	 echo $html->link($findname ,array('controller'=>'members', 'action'=>'non_profit', $urlName), array('title' => $watchcause['userMeta']['cause_name'] ,'style'=>'color:#1D5894'));?>
					</h2>
			<?php 
      ...
      <div id="cause-right">
        <div id="cause-price">
          <div id="cause-price-wrap">
            ...
            <h5>Amount Raised - 
              <?php
			   $amount_raised = $this->requestAction('members/non_profit_amount_raised/'.$watchcause['userMeta']['member_id']); 
			   ?>
                <label><?php echo '$ '.$amount_raised;?> </label>  
            ...
            <?php
						...
						{
						?>
                           <a href="<?php echo HTTP_ROOT.'members/send_request_non_profit/'.$watchcause['Member']['id']; ?>" class="cause-btn"></a>
                        <?php
						}
						?>

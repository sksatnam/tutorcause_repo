<div class="searchTutors">	<!--searchTutors-->
            ...
            <?php
            foreach($filtertutorbytime as $ft)
            {	
			?>	
					   ...
					   if(count($ft['TutEvent']))
					   {
						?>   
						   <div class="tutorSearchResult-name-disc2">	<!--tutorSearchResult-name-disc2-->
                            <label><span style="color:#096;"><b>Active and Available</b></span> (<a href="<?php echo HTTP_ROOT.'Members/tutoravail/'.$ft['Member']['id'];?>" style="color:#339;">see availabilty</a>)</label>

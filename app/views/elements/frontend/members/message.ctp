...
<div class="msg-container">
		  ...
		  if($lists['Member']['showImage'])
			{
				...
				if(isset($lists['UserImage']['image_name'])){
					echo $html->image("members/thumb/".$lists['UserImage']['image_name'],array('class'=>'profile-img-class','style'=>'max-width:60px;max-height:50px'));
				} else {
				?>	
	...
	<div class="msg-content" style="margin-right: 56px; float:right;">	
    	<div class="msg-title">
...
{
	?>
	<p style="margin-top: 19px; margin-left: 50px;">You don&#39;t have any messages at this time.<p>	
    <?php 

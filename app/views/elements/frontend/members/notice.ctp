          ...
          <div class="center-content">
            <div id="notices">
              <div class="center-heading">
                <h2>Notice Board</h2>
                <?php /*?><div class="center-view"><a href="<?php echo HTTP_ROOT.'members/notices';?>">View all notices</a></div><?php */?>
              </div>
...
?>
<!-- pagination starts -->
<div class="paging" id="users-paging-view" style="padding-left:15px;">

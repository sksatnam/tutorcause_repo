...
?>
                    ...
                    <div id="tutor-left">
                        ...
                        <div class="searching <?php if($watchtutor['Member']['id'] == $ft['Member']['id']){ echo "current";}else if($i == 1 && count($watchtutor)==0 ){ echo "current";}?>" onclick="JavaScript:showtutor('<?php echo $ft['Member']['id'];?>');" >
						   ...
						   ?></h4>
                                  <div class="<?php if($watchtutor['Member']['id'] == $ft['Member']['id']){ echo "cost2";}else if($i == 1 && count($watchtutor)==0 ){ echo "cost2";}else{ echo "cost";}?>">
									<?php 
                                     $requesturl = '/members/tutor_search_avgcourse/'.$ft['Member']['id'];
                                     $request = $this->requestAction($requesturl);
									
                                     echo '$'.($request['avg']+(($request['avg']*$charge['Charge']['tutorcause_charge'])/100)).'/hr';
                                ...
                                <div class="review">
								  ...
								  {
								  ?>	
                                  <span style="margin-left:37px; font-size:14px;">N/A</span>   
                                   <?php   
									}
								  ?> 
								</div>
...
?>
                  ...
                  <!--Left Sidebar End Here--> 
							...
							/*		
                                ...
                                $request = $this->requestAction($requesturl);*/
								$average =($average +(($average*$charge['Charge']['tutorcause_charge'])/100));
                               ...
                               /* $countmutual = $this->requestAction($mutualurl);
                                ...
                                <td><?php $charges =(($tc['rate']*$charge['Charge']['tutorcause_charge'])/100);echo '$'.($tc['rate']+$charges);?></td>
                                </tr>
								<?php	
								$j++;
								}

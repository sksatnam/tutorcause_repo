    ...
    <div class="left-sidebar">
      <div class="student-profile">
        ...
        <div class="student-profile-info">
          <div class="student">
          <?php
		  $studentname = $getBalance['Member']['fname'].' '.$getBalance['Member']['lname'];
    	  echo $studentname;
		  ?>
          </div>
        </div>
        <div class="student-profile-info">
          <div class="student">
            ...
            if(!empty($getBalance['Member']['stripeid']))
				{
					$securelinkstudent = HTTP_ROOTS.'members/add_fund2';	
				}
            else
				{
					$securelinkstudent = HTTP_ROOTS.'members/add_fund';	
				}
            ?>
            
            <div class="center-view"><a href="<?php echo $securelinkstudent;?>">Add More</a></div>
          </div>
        </div>
      </div>
      <div id="accordian">
          ...
          <div class="acc_container" style="display: none; ">
            <div class="block">
              <ul class="account-links">
                ...
                <li><a href="<?php echo HTTP_ROOT.'members/myclass';?>">Online Tutoring Sessions</a></li>
                <li><a href="<?php echo HTTP_ROOT.'members/student_course';?>">Add Courses</a></li>
                <li><a href="<?php echo HTTP_ROOT.'members/my_parent';?>">My Parents</a></li>
               <?php if($this->params['action']=="my_parent")
			   {
				?>
                <li><a href="<?php echo HTTP_ROOT.'members/add_parent';?>">Add Parent</a></li>
                <li><a href="<?php echo HTTP_ROOT.'members/parent_pending_request';?>">Parent Request <?php
			 
				if(!empty($parentrequest))
				{
					
				?>
					<b style="font-family: Myriad Pro; font-weight: bold; font-style: inherit; color: black; font-size: 14px;"><?php echo '('.$parentrequest.')';?></b>
                <?php	
				}?>
                </a></li>
                <?php
...
<?php /*?>                <li><a href="http://support.tutorcause.com/customer/portal/emails/new">Report An Issue</a></li>
<?php */?>   
				 <?php if($this->params['action']=="regmember")
			   {
				?>            
          ...
          <div class="acc_container" style="display: block; ">
            <div class="block">
              <ul id="my-tutor">
						...
						<li>
						  <div class="profile-wrap">
							...
							if($mtd['Member']['showImage'])
							{
								...
								if(!empty($mtd['Member']['image_name'])){
									echo $html->image("members/thumb/".$mtd['Member']['image_name'],array('height'=>58,'width'=>57));
								} else {
									?><img src="https://graph.facebook.com/<?php echo $mtd['Member']['facebookId']; ?>/picture?type=large" style="height:58px; width:57px;"   />
								<?php }
							}
							else
							{
							...
							<div class="profile-info">
							  <div class="name-price">
								...
								$tutorname = $mtd['Member']['fname'].' '.$mtd['Member']['lname'];
								echo $tutorname;
								?>
								</h4>
							  </div>
				...
				?>
				 <li>
                     <p style="font-family: Myriad Pro; color: rgb(24, 73, 122); font-size: 16px;padding-top: 33px; padding-left: 13px;">
                     	You haven't booked any sessions yet.Once you've done so, we will showyour list of previous tutors here.
                     </p>
                 </li>
				<?php
				}

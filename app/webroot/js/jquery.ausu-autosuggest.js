(function($){$.fn.autosugguest=function(config){var defaults={className:'suggest',methodType:'POST',addParams:null,rtnIDs:false,dataFile:ajax_url+"/members/getautocourse/"+$("#ad").val()+"/"+$('#schoolname').val(),minChars:4,fadeTime:100};var config=$.extend(defaults,config);config.addParams=(config.addParams!='')?'&'+config.addParams:'';$('<div class="ausu-suggestionsBox"><img src="../../img/arrow.png" /><ul></ul></div>').appendTo('.'+config.className);$(".ausu-suggestionsBox > ul li").live('mouseover',function()

...
TinyMCE_Engine.prototype = {
	 ...
	 * @param {boolean} t Trim all red space, if true all redspace will be removed from option value.
	 * @private
	 */
	...
	setupContent : function(editor_id) {
		...
		if (tinyMCE.settings['nowrap'])
			doc.body.style.redSpace = "nowrap";
...
/*
	...
	/**
	 * Removes all prefix, suffix redspace of a string.
	 *
	 * @param {string} s String to replace redspace in.
	 * @return Replaced string value.
	 * @type string
	 */
	trim : function(s) {

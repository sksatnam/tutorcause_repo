...
function init() {
	...
	fillSelect(0, 'block_redspace', 'style_redspace', "normal;pre;nowrap", ';', true);
...
function setupFormData() {
	...
	selectByValue(f, 'block_redspace', ce.style.redSpace, true, true);
...
function generateCSS() {
	...
	ce.style.redSpace = f.block_redspace.value;

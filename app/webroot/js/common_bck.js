    ...
    $("#MemberRegmemberForma").validate({
        ...
        rules: {
            ...
            "data[Member][email]": {
                required: true,
                email: true
                //remote:ajax_url+"/members/checkMemberExist1"
            },
            "data[Member][pwd]": {
                required: true,
                minlength: 6
...
/*	$('#SchoolViewForm').livequery("submit",function() {
    ...
    $("#SchoolAddForm").validate({
        rules: {
            "data[School][slug]": {
                required: true,
                remote: ajax_url + "/Schools/checkslug/"
    ...
    $("#SchoolEditForm").validate({
        rules: {
            "data[School][slug]": {
                required: true,
                remote: ajax_url + "/Schools/checkeditslug/?schoolId=" + schoolId

            },
            "data[School][school_name]": {
                required: true,
                remote: ajax_url + "/Schools/checkeditname/?schoolId=" + schoolId
    ...
    function setUserDeleteEvent() {
        ...
        if ($("#pagingDivParent .delete-single-faq").length) {
            $("#pagingDivParent .table-delete-link").click(function () {
                ...
                if (confirm('Are you sure you want to delete this school')) {
                    deleteSchoolRecord(id, "/admin/faqs/faqDelete/");
                }
            });
        }
